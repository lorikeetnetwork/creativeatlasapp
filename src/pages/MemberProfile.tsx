  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className={`flex flex-col md:flex-row items-start gap-6 ${member.banner_url ? '-mt-20 md:-mt-16' : ''}`}>
          <Avatar className={`h-32 w-32 border-4 border-background ${member.banner_url ? 'ring-4 ring-border' : ''}`}>
