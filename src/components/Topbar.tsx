...
const Topbar = ({
  ...
  return (
    <header className="h-14 flex-shrink-0 border-b-2 border-border bg-background flex items-center justify-between w-full p-0 m-0">
      <div className="flex items-center h-full pl-5">
        <Button
          variant="ghost"
          size="icon"
          onClick={onToggleSidebar}
          className="h-full w-14 rounded-none p-0 m-0"
        >
          {isSidebarCollapsed ? (
