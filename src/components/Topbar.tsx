import { LogOut, User, Menu, Plus, Calendar, Briefcase, Users, BookOpen, CreditCard, Compass, LayoutDashboard, Map, Sparkles, FileText, Award } from "lucide-react";
...
const Topbar = ({
  ...
  return (
    <header className={`h-14 flex-shrink-0 border-b-2 border-border bg-background flex items-center justify-between w-full p-0 m-0 ${className || ''}`}>
      {/* Logo */}
