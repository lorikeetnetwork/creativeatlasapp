...
const LocationList = ({
  ...
  return <div className="space-y-2">
      ...
      return <Card key={location.id} className={`p-3 cursor-pointer transition-all hover:shadow-md ${isSelected ? "ring-2 ring-primary shadow-sm" : ""}`} onClick={() => onLocationSelect(location)}>
            <div className="flex gap-3">
              {/* Thumbnail Placeholder */}
              <div className="w-14 h-14 flex-shrink-0 rounded bg-gradient-sunset opacity-10 bg-secondary-foreground" />
