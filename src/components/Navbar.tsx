...
const Navbar = ({ session: propSession }: NavbarProps) => {
  ...
  return (
    <header className="h-14 flex-shrink-0 border-b-2 border-border bg-background text-foreground flex items-center justify-between w-full sticky top-0 z-50" style={{ backgroundColor: 'hsl(0 0% 0%)', color: 'hsl(0 0% 100%)' }}>
      {/* Logo */}
